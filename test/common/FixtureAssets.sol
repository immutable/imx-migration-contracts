...
abstract contract FixtureAssets {
    ...
    TokenRegistry.TokenAssociation[] public fixAssets = [
        TokenRegistry.TokenAssociation(
            TokenRegistry.ImmutableXToken(
                88914301944088089141574999348394996493546404963067902156417732601144566237, 100_000_000
            ),
            NATIVE_IMX
        ),
        TokenRegistry.TokenAssociation(
            TokenRegistry.ImmutableXToken(1147032829293317481173155891309375254605214077236177772270270553197624560221, 1),
