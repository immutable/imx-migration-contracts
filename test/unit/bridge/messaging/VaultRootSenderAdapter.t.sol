...
contract VaultRootSenderAdapterTest is Test {
    ...
    address private constant L2_VAULT_PROCESSOR = 0x5Ffb1b3C4D6E8B7A9c1E8d3f2b5e6f7a8B9C0d1E;
    string private constant L2_VAULT_RECEIVER = "0x0987654321098765432109876543210987654321";
    ...
    function test_RevertIf_Constructor_ZeroRootSenderAddress() public {
    ...
    function test_RevertIf_Constructor_InvalidVaultReceiverAddress() public {
        vm.expectRevert(IAxelarExecutable.InvalidAddress.selector);
        new VaultRootSenderAdapter(L1_STARKEX_BRIDGE, "", L2_CHAIN_ID, gasService, gateway);
    }

    function test_RevertIf_Constructor_InvalidVaultReceiverChainId() public {
    ...
    function test_RevertIf_SendVaultRoot_CallerNotBridge() public {
        vm.expectRevert(VaultRootSenderAdapter.UnauthorizedRootSender.selector);
