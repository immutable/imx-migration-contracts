...
contract MockAssetsRegistry is TokenMappings {
    function registerAssetMapping(TokenMappings.AssetDetails memory assetInfo) public {
        _registerAssetMapping(assetInfo);
    }

    function registerAssetMapping(TokenMappings.AssetDetails[] memory assetInfos) public {
...
contract AssetsMappingRegistryTest is Test {
    ...
    function test_RegisterAssetMapping() public {
        TokenMappings.AssetDetails memory assetInfo =
    ...
    function test_RegisterTokenMappings() public {
        TokenMappings.AssetDetails[] memory assetInfos = new TokenMappings.AssetDetails[](2);
    ...
    function test_RevertIf_RegisterAsset_ZeroAssetId() public {
        TokenMappings.AssetDetails memory assetInfo = _createAssetDetails(0, TEST_QUANTUM, TEST_ASSET_ADDRESS);
    ...
    function test_RevertIf_RegisterAsset_ZeroQuantum() public {
        TokenMappings.AssetDetails memory assetInfo = _createAssetDetails(TEST_ASSET_ID, 0, TEST_ASSET_ADDRESS);
    ...
    function test_RevertIf_RegisterAsset_ZeroAddress() public {
        TokenMappings.AssetDetails memory assetInfo = _createAssetDetails(TEST_ASSET_ID, TEST_QUANTUM, address(0));
    ...
    function test_RevertIf_RegisterAssets_EmptyArray() public {
        TokenMappings.AssetDetails[] memory assetInfos = new TokenMappings.AssetDetails[](0);
    ...
    function test_RegisterAsset_Native() public {
        TokenMappings.AssetDetails memory nativeAsset =
            _createAssetDetails(TEST_ASSET_ID, TEST_QUANTUM, mockRegistry.NATIVE_IMX_ADDRESS());
        TokenMappings.AssetDetails memory nonNativeAsset =
    ...
    function _createImmutableXAsset(uint256 id, uint256 quantum)
        private
        pure
        returns (TokenMappings.ImmutableXAsset memory)
    {
        return TokenMappings.ImmutableXAsset(id, quantum);
    }

    function _createAssetDetails(uint256 id, uint256 quantum, address zkAddress)
        private
        pure
        returns (TokenMappings.AssetDetails memory)
    {
        return TokenMappings.AssetDetails(_createImmutableXAsset(id, quantum), zkAddress);
    }
}
